...
if (isset($_POST['email']) && !empty($_POST['email'])) {
	...
	if (mysqli_fetch_row($res) > 0) {
		...
		if ($out['active'] == true) {
			...
			$subject = "QuickFileHosting.EU - Password Recovery";
			$message = "<html>
	<head>
		<style>
			.text {
	...
	<body>
		...
		<div class='container'>
			<p class='text'>An account password reset was called at quickfilehosting.eu using that e-mail address.</p>
			...
			<p class='text'><a href='https://quickfilehosting.eu/account/recoverpassaction.php?recoverhash=". $hash ."'>https://quickfilehosting.eu/account/recoverpassaction.php?recoverhash=". $hash ."</a></p>
			...
			Sleep(2);
			die ("<link rel='stylesheet' type='text/css' href='/data/css/style.css'><center><img onclick=\"location.href='https://quickfilehosting.eu';\" class='logoimage' src='/data/images/logo.png'></center><div class='text' style='text-align: center; margin: 50px auto; border: 5px solid green; width: 500px; font-size: 125%;'> Password recover email successfully send. </div>");
		} else {
			die ("<link rel='stylesheet' type='text/css' href='/data/css/style.css'><center><img onclick=\"location.href='https://quickfilehosting.eu';\" class='logoimage' src='/data/images/logo.png'></center><div class='text' style='text-align: center; margin: 50px auto; border: 5px solid red; width: 500px; font-size: 125%;'> Account not active. </div>");
		}
	} else {
		...
		<div class="info">
			...
			<div class="langselect">
				...
				<ul class="list">
					...
					<li><a href="?locale=deu" title="Deutch">Deutch</a></li>
				</ul>
			</div>
