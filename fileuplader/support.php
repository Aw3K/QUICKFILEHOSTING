...
<html>
	<head>
		<title>Quick File Hosting - Report Issue</title>
	...
	<body>
		...
		<div class="container" id="container">
			<center><form id="contactform" style="margin: 10px auto 10px auto; max-width: 640px;" action="supportaction.php" method="post">
				...
				<input style="border-radius: 5px; width: 220px; border: 1px solid green;" type="text" name="topic"></div><br>
				<textarea class="TEXTAREAASC" name="msg" rows="4" form="contactform"></textarea>
				<p class="text" style="margin-top: 7px;"> NOTICE: Please use english while reporting issue to us. </p>
				<input style="color: green; border: 2px solid green; border-radius: 5px; font-size: 110%; margin-right: 6px; margin-top: 5px;"
